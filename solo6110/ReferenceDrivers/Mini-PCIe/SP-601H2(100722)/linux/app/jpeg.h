...
#define jpeg_set_soi(ptr)		memcpy((unsigned char *)(ptr) + SOI_OFFSET, JPEG_SOI, SOI_LEN)
...
#define jpeg_set_dqt(ptr, qp)	memcpy((unsigned char *)(ptr) + DQT_OFFSET, JPEG_DQT[qp], DQT_LEN)
...
#define jpeg_set_dht(ptr)		memcpy((unsigned char *)(ptr) + DHT_OFFSET, JPEG_DHT, DHT_LEN)
...
static inline void jpeg_set_sof(unsigned char *ptr, unsigned int width, unsigned int height)
{
...
#define jpeg_set_sos(ptr)		memcpy((unsigned char *)(ptr) + SOS_OFFSET, JPEG_SOS, SOS_LEN)

static inline void jpeg_set_header(unsigned char *ptr, unsigned int qp, unsigned int width, unsigned int height)
{
	jpeg_set_soi(ptr);
	jpeg_set_dqt(ptr, qp);
	jpeg_set_dht(ptr);
