#ifndef __SOLO6x10FB_H
#define __SOLO6x10FB_H

#define IOCTL_FB_MAGIC	'f'

struct SOLO6x10FB_RECT
{
	unsigned int x;
	unsigned int y;
	unsigned int width;
...
struct SOLO6x10FB_CURSOR_POS
{
	unsigned int x;
	unsigned int y;
};

#define IOCTL_FB_FLUSH	_IOW(IOCTL_FB_MAGIC, 0, struct SOLO6x10FB_RECT)
#define IOCTL_FB_ERASE	_IOW(IOCTL_FB_MAGIC, 1, struct SOLO6x10FB_RECT)
#define IOCTL_FB_CURSOR_ON	_IO(IOCTL_FB_MAGIC, 2)
#define IOCTL_FB_CURSOR_OFF	_IO(IOCTL_FB_MAGIC, 3)
#define IOCTL_FB_CURSOR_POS	_IOW(IOCTL_FB_MAGIC, 4, struct SOLO6x10FB_CURSOR_POS)
