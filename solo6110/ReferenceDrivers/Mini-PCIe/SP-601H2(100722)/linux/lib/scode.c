...
//    printf("fd %x %x %x \n", enc_fd, disp_fd, dec_fd );
	...
	disp = solo6x10_display_open(disp_device_path, MUX_MODE_16CH);
    return 0;
}
...
int VideoDecode(unsigned char* buf, int size)
{
    ...
    if(tmpinit==0)
    {
        solo6x10_display_channel_mode(disp, 0, 4);
        solo6x10_display_channel_mode(disp, 1, 4);
        solo6x10_display_channel_mode(disp, 2, 4);
        solo6x10_display_channel_mode(disp, 3, 4);
        solo6x10_display_channel_mode(disp, 4, 4);
        solo6x10_display_channel_mode(disp, 5, 4);
        solo6x10_display_channel_mode(disp, 6, 4);
        solo6x10_display_channel_mode(disp, 7, 4);
        solo6x10_display_channel_mode(disp, 8, 4);
        solo6x10_display_channel_mode(disp, 9, 4);
        solo6x10_display_channel_mode(disp, 10, 4);
        solo6x10_display_channel_mode(disp, 11, 4);
        solo6x10_display_channel_mode(disp, 12, 4);
        solo6x10_display_channel_mode(disp, 13, 4);
        solo6x10_display_channel_mode(disp, 14, 4);
        solo6x10_display_channel_mode(disp, 15, 4);        
	solo6x10_display_mux_mode(disp, 5);
        tmpinit=1;
    }
...
{
    solo6x10_display_motion_trace(disp, 1);

    return 0;
}
int StopMotionDetection (int hChannelHandle)
{
    solo6x10_display_motion_trace(disp, 0);
