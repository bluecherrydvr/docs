...
BEGIN_MESSAGE_MAP(CRTPSampleApp, CWinApp)
...
// 僅有的一個 CRTPSampleApp 物件

CRTPSampleApp theApp;


// CRTPSampleApp 初始設定

BOOL CRTPSampleApp::InitInstance()
{
