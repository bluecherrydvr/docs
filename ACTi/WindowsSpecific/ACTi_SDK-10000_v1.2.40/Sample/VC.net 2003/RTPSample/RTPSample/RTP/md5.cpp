...
static void md5_append(md5_state_t *, const md5_byte_t *, int);
/* Finish the message and return the digest. */
static void md5_finish(md5_state_t *, md5_byte_t *);
static void md5_process(md5_state_t *, const md5_byte_t *);

void md5_generate(char *input, char *output, int len)
{
	int             i;
	md5_state_t     state;
