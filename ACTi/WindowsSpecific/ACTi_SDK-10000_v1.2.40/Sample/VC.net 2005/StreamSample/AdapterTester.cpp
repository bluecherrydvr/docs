...
BEGIN_MESSAGE_MAP(CAdapterTesterApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// CAdapterTesterApp 建構

CAdapterTesterApp::CAdapterTesterApp()
{
	// TODO: 在此加入建構程式碼，
...
// 僅有的一個 CAdapterTesterApp 物件

CAdapterTesterApp theApp;


// CAdapterTesterApp 初始設定

BOOL CAdapterTesterApp::InitInstance()
{
