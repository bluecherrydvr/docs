...
#define STREAM_E_NOT_HANDLED		0x80030006
#define STREAM_E_UNKNOWN_PACKET		0x80030007
#define STREAM_E_LAST  				0x800300FF
#define STREAM_S_WAITSTOP 			0x00030000
#define STREAM_S_STOPCONNECTION		0x00030001
#define STREAM_S_ONLYUSERDATA		0x00030002	// only the location is correct
#define STREAM_S_WITHUSERDATA		0x00030003	// the location is also correct
...
#define PACKET_E_NOT_HANDLED		0x80030104
