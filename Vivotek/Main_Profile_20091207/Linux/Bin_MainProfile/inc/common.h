/*
 *******************************************************************************
 * $Header: /RD_1/Project/VNDP/MainProfile/common/src/common.h 2     05/11/09 4:14p Bruce $
 *
 ...
 * 
 * *****************  Version 2  *****************
 * User: Bruce        Date: 05/11/09   Time: 4:14p
 ...
 * 
 * *****************  Version 3  *****************
 * User: Perkins      Date: 05/06/28   Time: 1:10p
 * Updated in $/RD_1/Project/VNDP/MainProfile/common/src
 * let _WIN32 or WIN32 both defined DLLAPI
 * 
 * *****************  Version 2  *****************
 * User: Perkins      Date: 05/06/07   Time: 8:14p
 * Updated in $/RD_1/Project/VNDP/MainProfile/common/src
 * add rtsp extension key value
 * 
 * *****************  Version 1  *****************
...
#else
  #define DLLAPI
#endif //defined(_WIN32) || WIN32
#endif //defined(DLLAPI)

/*! Use for generate dynamic link library for Windows */
#ifndef DEFEXPAPI
#ifdef _WIN32
  #define DEFEXPAPI __stdcall
#else
  #define DEFEXPAPI
#endif //defined(_WIN32)
#endif //defined(DEFEXPAPI)
