# Makefile - NonBlockingPTZWithMoveCamera

SolutionDir = ../vcproj/
SolutionName = NonBlockingPTZWithMoveCamera
PlatformName = Linux
...
ifndef TARGET
TARGET=NonBlockingPTZWithMoveCamera.exe
endif
else
ifeq "$(CFG)" "Release"
...
HEADER_FILES= \
	../inc/NonBlockingPTZWithMoveCamera.h
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) NonBlockingPTZWithMoveCamera.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > NonBlockingPTZWithMoveCamera.dep

-include NonBlockingPTZWithMoveCamera.dep
