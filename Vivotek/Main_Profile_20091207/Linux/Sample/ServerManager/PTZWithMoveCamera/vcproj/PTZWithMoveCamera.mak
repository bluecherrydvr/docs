# Makefile - PTZWithMoveCamera

SolutionDir = ../vcproj/
SolutionName = PTZWithMoveCamera
PlatformName = Linux
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) PTZWithMoveCamera.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > PTZWithMoveCamera.dep

-include PTZWithMoveCamera.dep
