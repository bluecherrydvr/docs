# Makefile - GetSetVideoInfo

SolutionDir = ../vcproj/
SolutionName = GetSetVideoInfo
PlatformName = Linux
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) GetSetVideoInfo.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > GetSetVideoInfo.dep

-include GetSetVideoInfo.dep
