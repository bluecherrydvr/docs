# Makefile - NonBlockingPTZWithSendPTZCommand

SolutionDir = ../vcproj/
SolutionName = NonBlockingPTZWithSendPTZCommand
PlatformName = Linux
...
ifndef TARGET
TARGET=NonBlockingPTZWithSendPTZCommand.exe
endif
else
ifeq "$(CFG)" "Release"
...
HEADER_FILES= \
	../inc/NonBlockingPTZWithSendPTZCommand.h
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) NonBlockingPTZWithSendPTZCommand.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > NonBlockingPTZWithSendPTZCommand.dep

-include NonBlockingPTZWithSendPTZCommand.dep
