# Makefile - PTZWithSendPTZCommand

SolutionDir = ../vcproj/
SolutionName = PTZWithSendPTZCommand
PlatformName = Linux
...
ifndef TARGET
TARGET=PTZWithSendPTZCommand.exe
endif
else
ifeq "$(CFG)" "Release"
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) PTZWithSendPTZCommand.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > PTZWithSendPTZCommand.dep

-include PTZWithSendPTZCommand.dep
