# Makefile - PresentLocation

SolutionDir = ../vcproj/
SolutionName = PresentLocation
PlatformName = Linux
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) PresentLocation.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > PresentLocation.dep

-include PresentLocation.dep
