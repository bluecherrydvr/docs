# Makefile - GetSetNetworkInfo

SolutionDir = ../vcproj/
SolutionName = GetSetNetworkInfo
PlatformName = Linux
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) GetSetNetworkInfo.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > GetSetNetworkInfo.dep

-include GetSetNetworkInfo.dep
