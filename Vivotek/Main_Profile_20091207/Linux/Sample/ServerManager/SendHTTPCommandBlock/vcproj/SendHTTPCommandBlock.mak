# Makefile - SendHTTPCommandBlock

SolutionDir = ../vcproj/
SolutionName = SendHTTPCommandBlock
PlatformName = Linux
...
ifndef TARGET
TARGET=SendHTTPCommandBlock.exe
endif
else
ifeq "$(CFG)" "Release"
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) SendHTTPCommandBlock.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > SendHTTPCommandBlock.dep

-include SendHTTPCommandBlock.dep
