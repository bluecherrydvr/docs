# Makefile - NonBlockingSendHTTPCommand

SolutionDir = ../vcproj/
SolutionName = NonBlockingSendHTTPCommand
PlatformName = Linux
...
ifndef TARGET
TARGET=NonBlockingSendHTTPCommand.exe
endif
else
ifeq "$(CFG)" "Release"
...
HEADER_FILES= \
	../inc/NonBlockingSendHTTPCommand.h
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) NonBlockingSendHTTPCommand.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > NonBlockingSendHTTPCommand.dep

-include NonBlockingSendHTTPCommand.dep
