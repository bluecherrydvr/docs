# Makefile - ConnectMultipleStreamDevice

SolutionDir = ../vcproj/
SolutionName = ConnectMultipleStreamDevice
PlatformName = Linux
...
ifndef TARGET
TARGET=ConnectMultipleStreamDevice.exe
endif
else
ifeq "$(CFG)" "Release"
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) ConnectMultipleStreamDevice.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > ConnectMultipleStreamDevice.dep

-include ConnectMultipleStreamDevice.dep
