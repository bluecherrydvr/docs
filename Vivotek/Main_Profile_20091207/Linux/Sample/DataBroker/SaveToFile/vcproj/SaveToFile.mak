...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) SaveToFile.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > SaveToFile.dep

-include SaveToFile.dep
