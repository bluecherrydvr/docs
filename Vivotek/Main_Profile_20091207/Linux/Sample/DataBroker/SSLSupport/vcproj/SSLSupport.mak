...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) SSLSupport.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > SSLSupport.dep

-include SSLSupport.dep
