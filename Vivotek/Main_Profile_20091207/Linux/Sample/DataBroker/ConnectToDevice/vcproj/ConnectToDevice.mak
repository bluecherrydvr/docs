# Makefile - ConnectToDevice

SolutionDir = ../vcproj/
SolutionName = ConnectToDevice
PlatformName = Linux
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) ConnectToDevice.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > ConnectToDevice.dep

-include ConnectToDevice.dep
