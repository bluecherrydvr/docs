...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) Reconnect.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > Reconnect.dep

-include Reconnect.dep
