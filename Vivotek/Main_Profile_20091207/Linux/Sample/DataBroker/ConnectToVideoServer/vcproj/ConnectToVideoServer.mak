# Makefile - ConnectToVideoServer

SolutionDir = ../vcproj/
SolutionName = ConnectToVideoServer
PlatformName = Linux
...
ifndef TARGET
TARGET=ConnectToVideoServer.exe
endif
else
ifeq "$(CFG)" "Release"
...
.PHONY: clean
clean:
	-rm -f -v $(OBJS) $(TARGET) ConnectToVideoServer.dep

.PHONY: depends
depends:
	-$(CXX) $(CXXFLAGS) $(CPPFLAGS) -MM $(filter %.c %.cc %.cpp %.cxx,$(SRCS)) > ConnectToVideoServer.dep

-include ConnectToVideoServer.dep
