...
int saa7128_setup(struct SOLO6010 *solo6010, int i2c_channel, u8 dev_addr)
{
	int i;
	...
	for(i=0; i<128; i++)
	{
		...
		solo6010_i2c_writebyte(solo6010, i2c_channel, dev_addr, i, regs[i]);
	}
