...
int     StartVideoPreviewEx(int hChannelHandle, PREVIEWCONFIG*  pPreviewConf, UINT useSyncSem,
                            UINT mode);
int     SetBlockArea(int hChannelHandle, UINT x, UINT y, UINT w, UINT h);

int     SetEncodePara (int hChannelHandle, int scale, int qp, int intvl, int gop, int mask);
int     GetEncodePara(int hChannelHandle, VideoStandard_t*  videoStandard, int*  scale,
                     int*  qp, int*  intvl, int*  gop);
