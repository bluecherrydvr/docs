...
///////////////////////////////////////////////////////////////////////////////
#if defined(IS_SSE)
int DeinterlaceFieldBob_SSE(DEINTERLACE_INFO *info)
#elif defined(IS_3DNOW)
int DeinterlaceFieldBob_3DNOW(DEINTERLACE_INFO *info)
#else
int DeinterlaceFieldBob_MMX(DEINTERLACE_INFO *info)
#endif
{
    int Line;
    short* YVal1;
